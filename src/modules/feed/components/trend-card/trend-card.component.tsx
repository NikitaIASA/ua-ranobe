...
import "./trend-card.component.scss";
...
export const TrendCard: FC<TrendCardProps> = ({
  ...
  return (
    <div className="trend-card">
      <img className="trend-card__image" src={image} alt="#" />
      <p className="trend-card__description">{description}</p>
      <p className="trend-card__author">{author}</p>
      <div className="trend-card__statistics statistics">
